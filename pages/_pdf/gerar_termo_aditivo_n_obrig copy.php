...
$template_path = __DIR__ . '../layouts/termo_aditivo_n_obrig.html';
...
if (!file_exists($template_path)) {
    ...
    if (!file_exists($template_path)) {
        $template_path = __DIR__ . '/../layouts/termo_aditivo_n_obrig.html'; 
        if (!file_exists($template_path)) {
            die("Erro FATAL: Arquivo de layout do Termo (termo_aditivo_n_obrig.html) não encontrado. Tente verificar o caminho absoluto: " . $template_path);
        }
    }
}
...
try {
    ...
    $mpdf->Output("termo_aditivo_n_obrig_" . str_replace('.', '_', $alunoProntuario) . ".pdf", 'I');
